...
const RecipeListPage = () => {
  ...
  const [responseDataDescription, setResponseDataDescription] = useState([]);
  ...
  // for each intolerance selected, send to this page "&intolerance=*intoleranceselected*"
  ...
  useEffect(() => {
    axios.get(`https://api.spoonacular.com/recipes/complexSearch?apiKey=a5c113f14a144ce89576d7bcbc7f3dca&diet=${foodDiet}&intolerance=${foodIntolerance}`)
